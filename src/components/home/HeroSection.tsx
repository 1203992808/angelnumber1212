...
const HeroSection = () => {
  ...
  return (
    <section className="relative pt-16 pb-12 md:pt-24 md:pb-20 overflow-hidden min-h-screen flex items-center">
      ...
      <div className="container mx-auto px-4 relative z-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          <div className={`text-center lg:text-left transition-all duration-1000 ease-out ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <div className="inline-flex items-center px-5 py-2 bg-gradient-to-r from-gold-300/20 to-accent-400/20 backdrop-blur-sm rounded-full mb-6 border border-white/20 shadow-lg">
              <span className="flex w-2.5 h-2.5 rounded-full bg-gold-300 mr-3 animate-pulse"></span>
              <span className="text-gold-300 font-semibold tracking-wider text-sm uppercase">DIVINE MESSAGE</span>
            </div>
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white leading-tight mb-6">
              Discover Your <span className="relative inline-block">
                ...
                <span className="absolute -inset-1 bg-gradient-to-r from-gold-300/30 to-gold-400/30 blur-md z-0"></span>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center lg:justify-start">
              <Link 
                href="/meaning" 
                className="group inline-flex items-center bg-gradient-to-r from-gold-300 to-accent-400 text-primary-900 font-bold text-lg px-10 py-4 rounded-full shadow-lg hover:shadow-gold-300/40 transition-all duration-300 transform hover:-translate-y-1 hover:scale-105 overflow-hidden"
              >
                <span className="flex items-center justify-center">
                  <span>Explore Meaning</span>
                ...
                <span className="absolute inset-0 bg-gradient-to-r from-accent-400 to-gold-300 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>
              </Link>
            </div>
          </div>
          ...
          <div className={`hidden lg:flex justify-center lg:justify-end transition-all duration-1000 ease-out delay-300 ${isLoaded ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
            <div className="relative w-80 h-80 md:w-[420px] md:h-[420px]">
              ...
              <div className="absolute -inset-8 bg-gradient-to-r from-mystical-500/20 via-accent-500/5 to-primary-700/10 rounded-full blur-[60px] z-0"></div>
              
              {/* Outer ring with glow */}
              <div className="absolute -inset-3 bg-gradient-to-r from-gold-300/30 to-accent-500/30 rounded-full blur-xl animate-pulse"></div>
              <div className="absolute -inset-1 border-2 border-white/30 rounded-full animate-spin-slow"></div>
              
              {/* Inner rings */}
              <div className="absolute inset-6 border-4 border-gold-300/40 rounded-full animate-reverse-spin-slow"></div>
              
              {/* Central element */}
              <div className="absolute inset-12 bg-gradient-to-br from-primary-700 to-accent-700 rounded-full flex items-center justify-center shadow-2xl">
                ...
                <span className="text-7xl md:text-8xl font-bold text-white drop-shadow-lg relative">
                  1212
        ...
        <div className={`mt-12 md:mt-16 transition-all duration-1000 ease-out delay-500 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 text-center">
            <div className="bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-sm p-4 sm:p-5 rounded-xl hover:bg-white/15 transition-all duration-300 transform hover:-translate-y-1 group border border-white/10 shadow-lg">
              <div className="w-12 h-12 bg-gradient-to-br from-gold-300 to-gold-400 rounded-xl mb-3 mx-auto flex items-center justify-center group-hover:scale-110 transition-transform shadow-gold-300/30">
              ...
              <h3 className="text-lg font-semibold text-white mb-2">Spiritual Growth</h3>
              <p className="text-white/80 text-sm">Find inner power & purpose through divine guidance</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-sm p-4 sm:p-5 rounded-xl hover:bg-white/15 transition-all duration-300 transform hover:-translate-y-1 group border border-white/10 shadow-lg">
              ...
              <h3 className="text-lg font-semibold text-white mb-2">Love & Relationships</h3>
              <p className="text-white/80 text-sm">Attract & maintain harmony in meaningful connections</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-sm p-4 sm:p-5 rounded-xl hover:bg-white/15 transition-all duration-300 transform hover:-translate-y-1 group border border-white/10 shadow-lg">
              ...
              <p className="text-white/80 text-sm">Discover your calling and professional purpose</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-sm p-4 sm:p-5 rounded-xl hover:bg-white/15 transition-all duration-300 transform hover:-translate-y-1 group border border-white/10 shadow-lg">
              ...
              <h3 className="text-lg font-semibold text-white mb-2">Personal Transformation</h3>
              <p className="text-white/80 text-sm">Embrace life's pivotal moments with confidence</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 z-20 flex flex-col items-center opacity-60 hover:opacity-100 transition-opacity">
        <span className="text-white/70 text-xs uppercase tracking-wider mb-1">Scroll</span>
        <div className="w-5 h-8 border border-white/30 rounded-full flex justify-center p-1">
          <div className="w-1 h-1 bg-gold-300 rounded-full animate-bounce-slow"></div>
        </div>
      </div>
    </section>
  );
