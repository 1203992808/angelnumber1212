      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          <div className="mb-20 motion-safe:animate-fade-in-up">
            <span className="inline-block text-gold-300 text-lg font-semibold mb-4 tracking-wider px-5 py-2 bg-white/5 backdrop-blur-sm rounded-full border border-white/10">DIVINE GUIDANCE FOR YOU</span>
            <h2 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-8 leading-tight">
              Unlock Your Personal <span className="relative inline-block">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16 motion-safe:animate-fade-in-up delay-500">
            <div className="bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-sm p-8 rounded-2xl hover:bg-white/15 transition-all duration-300 transform hover:-translate-y-2 border border-white/10 group shadow-xl">
              <div className="bg-gradient-to-br from-gold-300 to-gold-400 text-primary-900 rounded-xl w-16 h-16 flex items-center justify-center mx-auto mb-6 shadow-lg group-hover:scale-110 transition-transform duration-300 shadow-gold-300/30">
          ...
          <div className="flex justify-center items-center motion-safe:animate-fade-in-up delay-700">
            <Link 
              href="/meaning" 
              className="group inline-flex items-center bg-gradient-to-r from-gold-300 to-accent-400 text-primary-900 font-bold text-lg px-12 py-5 rounded-full shadow-lg hover:shadow-gold-300/40 transition-all duration-300 transform hover:-translate-y-1 hover:scale-105 relative overflow-hidden"
            >
              <span className="flex items-center justify-center relative z-10">
                <span>Explore 1212 Meanings</span>
                <svg className="w-6 h-6 ml-2 transform group-hover:translate-x-1 transition-transform" fill="currentColor" viewBox="0 0 20 20">
